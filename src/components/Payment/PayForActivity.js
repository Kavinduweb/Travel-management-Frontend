...
export default class PayForActivity extends Component{
  ...
  constructor(props){
   ...
   componentDidMount(){
    ...
    axios.get(`https://trabackend1223.herokuapp.com/activities/${id}`).then((res)=>{
         this.setState({
...
const{activityName,price}=this.state;
      ...
      axios.post("https://trabackend1223.herokuapp.com/payment/add",data).then((res=>{
        if(res.data.success){
          this.setState(
...
<div class="card" style={{backgroundColor:"#78766F"}}>    
   <div class="card-body" >
        <div class="row" >
            ...
            <div class="col-md-5" >
                ...
                <div class="text-center mb-2"> <h2>Your Selected Activity</h2> </div>
                <hr  class="text-center mb-4"/>
                    <h4 style={{color:"hsl(0,0%,0%,0.6)"}}>{activityName}</h4>
                    <div >
 ...
 <div class="input-group mb-3">
  ...
  <input type="text" className="form-control" name="reference" value={activityName} onChange={this.onChangeReference} disabled />
</div></div>
...
<div class="d-flex flex-row align-items-center mb-3">
              ...
              <label class="form-label fw-bold mr-4" ><i class="fas fa-plane mr-3"></i> Pay For &nbsp; </label>  
                   ...
                   <input type="text" className="form-control" name="payf" value="Activity" onChange={this.onChangePay} disabled  />
