...
export default class PackageDetailsAdmin extends Component {
...
const {packageName,destination,district,date,noofdays,noofnights,vehical,perperson} = this.state.post;
  ...
  return(
   ...
   <table>
       <td>
    <button class="btn btn-danger"><a href ={`/travelpackages/admin/edit/${this.state._id}`} style={{textDecoration:'none' ,color:'white'}}>Edit Package</a></button>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
        <button class="btn btn-danger" ><a href="/" style={{textDecoration:'none' ,color:'white'}} >Delete Package</a></button>
        </td>
        </table>
    </div>
