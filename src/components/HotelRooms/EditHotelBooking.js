...
export default class EditHotelBooking extends Component{
    ...
    axios.put(`https://trabackend1223.herokuapp.com/hotelbooking//update/${id}`,data).then((res)=>{
        if(res.data.success){
    ...
    componentDidMount(){
        const id = this.props.match.params.id;
        axios.get(`https://trabackend1223.herokuapp.com/hotelbooking/read/${id}`).then((res)=>{
          if (res.data.success){
             this.setState({
