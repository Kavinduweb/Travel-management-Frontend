...
export default class adminhotelpackageDetails extends Component {
  ...
  componentDidMount(){
    ...
    axios.get(`https://trabackend1223.herokuapp.com/hotelpackage/read/${id}`).then((res)=>{
      if (res.data.success){
         this.setState({
  ...
  onDelete=(id)=>{
    ...
    axios.delete(`https://trabackend1223.herokuapp.com/hotelpackage/delete/${id}`).then((res)=>{
